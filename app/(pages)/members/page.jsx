        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white/30 backdrop-blur-xl rounded-2xl p-8 text-gray-900 border border-white/40 shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl duration-300 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-3 text-blue-900">Member 1</h3>
              <p className="opacity-90 text-lg">Creative designer and frontend developer.</p>
            </div>
            <div className="group bg-white/30 backdrop-blur-xl rounded-2xl p-8 text-gray-900 border border-white/40 shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl duration-300 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-3 text-green-900">Member 2</h3>
              <p className="opacity-90 text-lg">Backend specialist and API architect.</p>
            </div>
            <div className="group bg-white/30 backdrop-blur-xl rounded-2xl p-8 text-gray-900 border border-white/40 shadow-xl transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl duration-300 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-3 text-purple-900">Member 3</h3>
              <p className="opacity-90 text-lg">Fullstack developer and project manager.</p>
            </div>
          </div>
        </div>
      </div>
